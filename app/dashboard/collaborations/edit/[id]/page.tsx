...
export default function CollaborationEditPage({ params }: { params: { id: string } }) {
        ...
        <div className="container mx-auto pb-20">
                            ...
                            <div className="bg-white rounded-xl border border-gray-200 p-5 shadow-lg">
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Textarea
                                            defaultValue="Looking for an influencer to showcase our luxury villa with ocean views."
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <Select defaultValue="listing1">
                                            <SelectTrigger>
                                                <SelectValue placeholder="Choose which Airbnb listing this collaboration is for" />
                                            </SelectTrigger>
                                            <SelectContent>
            ...
            <Dialog open={open} onOpenChange={setOpen}>
                <DialogContent className="sm:max-w-md">
                    <DialogHeader>
                        <DialogTitle>Collaboration Updated</DialogTitle>
                        <DialogDescription>
                            The collaboration details have been saved successfully.
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
