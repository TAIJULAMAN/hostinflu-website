                    ...
                    <div className="flex-1 overflow-y-auto">
                        {filteredUsers.map((user) => (
                            ...
                            >
                                ...
                                {user.unread > 0 && (
                                    <div className="bg-teal-600 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center">
                                        {user.unread}
                                    </div>
                                )}
                            </div>
                            ...
                            >
                                ...
                                >
                                    ...
                                    <div className="flex items-center justify-between mt-2 gap-2">
                                        <span
                                            className={`text-xs ${msg.sender === "me" ? "text-teal-100" : "text-gray-500"
                                                }`}
                                        >
                                            {msg.time}
                                        </span>
